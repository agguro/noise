...
/* sudo apt install freeglut3-dev libnoise-dev */

// g++ -no-pie worms.cpp -o worms -I/usr/include/ -L/usr/local/lib -lnoise -lGL -lGLU -lglut
...
static char* g_pTextureData = (char*)
